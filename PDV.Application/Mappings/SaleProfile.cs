    ...
    public class SaleProfile : Profile
    {
        public SaleProfile()
        {
            CreateMap<Sale, SaleDetailsDTO>()
                ...
                .ForMember(dest => dest.CashOperator, 
                            opt => opt.MapFrom(src => src.CashSession.OperatorName))
            ...
            CreateMap<SaleProduct, SaleProductDTO>()
                ...
                .ForMember(dest => dest.PriceAtSaleTime, 
                            opt => opt.MapFrom(src => src.PriceAtSaleTime))
